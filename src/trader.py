...
class ProductTrader:
    ...
    def get_orders(self):
        if self.name == STATIC_SYMBOL:
            return StaticTrader.get_orders(self)
        if self.name == DYNAMIC_SYMBOL:
            return DynamicTrader.get_orders(self)
...
class Trader:
    ...
    def run(self, state: TradingState):
        ...
        return result, final_trader_data, prints
